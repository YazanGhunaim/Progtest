          ...
          long long int *b1, long long int *b2)
{
    ...
    int numOfDaysStrikesb1 = NumOfDaysBetweenDates(y1, m1, d1, y2, m2, d2) * STRIKES_IN_ONE_DAY_BELL1;
    int numOfDaysStrikesb2 = NumOfDaysBetweenDates(y1, m1, d1, y2, m2, d2) * STRIKES_IN_ONE_DAY_BELL2;
...
int main()
{
    ...
    printf("%lld\n", NumOfDaysBetweenDates(2022, 10, 2, 2022, 10, 3));

    printf("%lld\n", countStrikes(13, 15, 23, 59));
    printf("%lld\n", countStrikes(0, 0, 11, 20));

    printf("%lld\n", countStrikesBetweenTimesb2(13, 15, 23));
    ...
    //     printf("%d", bells(2022, 10, 3, 13, 15,
    //                  2022, 10, 4, 11, 20, &b1, &b2));
}
